...
def test_get_list_resources(page, per_page, status, resources_list):
    """
    This test checks status code and schema for list resources (resources found/resources not found)
    """
...
def test_get_resource(num_id, status, resource):
    """
    This test checks status code and schema for single resources (single resources found/single resources not found)
    """
